...
const PickerModalProvince = ({pickerVisible,onPressCancel,onPressSubmit,selectOne,onChangeOne}) => {
  return(
    <Modal
    ...
    >
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 0.35, backgroundColor:'white', borderColor:'#C7C7C7', borderWidth: 0.5 }} >
          ...
          <ProvincePicker
            selectProvince = {selectOne}
            onChangeProvince = {onChangeOne}
          />
        </View>
      </View>
    </Modal>
